...
SLIM_SCRIPT="/xdisk/mcnew/finches/dannyjackson/simulations/simulation_replicates.extended_generations.slim"

PY_ENV="recap_py"
PY_SCRIPT="/xdisk/mcnew/finches/dannyjackson/simulations/recap_fst_tajd.py"

OUTBASE="/xdisk/mcnew/finches/dannyjackson/simulations/extended_generations/${AF}/output"
